...
The genetics app **extends** the existing 592,215 protein discoveries rather than replacing them:
...
- **Shared Data:** Both apps use the same 592,215 protein discoveries from chunked JSON.gz files
